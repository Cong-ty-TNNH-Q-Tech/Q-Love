...
func (m *mockAuctionWalletRepo) HoldBalance(ctx context.Context, userID uuid.UUID, amount float64) error { return nil }
func (m *mockAuctionWalletRepo) ReleaseHoldBalance(ctx context.Context, userID uuid.UUID, amount float64) error { return nil }

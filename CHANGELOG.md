...
- [backend/server/services] Sửa lỗi LocketService không thực sự upload ảnh lên R2 (Issue #112): Implement `UploadFile` thông qua R2Client, truyền file thực sự (io.Reader) và content type thay vì dummy URL.
